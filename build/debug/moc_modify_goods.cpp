...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_modify_goods_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_modify_goods_t qt_meta_stringdata_modify_goods = {
    {
QT_MOC_LITERAL(0, 0, 12), // "modify_goods"
QT_MOC_LITERAL(1, 13, 2), // "re"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 20), // "on_btn_query_clicked"
QT_MOC_LITERAL(4, 38, 14), // "read_from_flie"
QT_MOC_LITERAL(5, 53, 21), // "on_btn_cancel_clicked"
QT_MOC_LITERAL(6, 75, 10), // "renew_file"
QT_MOC_LITERAL(7, 86, 21) // "on_btn_submit_clicked"
...
void modify_goods::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<modify_goods *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->re(); break;
        ...
        {
            using _t = void (modify_goods::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&modify_goods::re)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject modify_goods::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_modify_goods.data,
    qt_meta_data_modify_goods,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *modify_goods::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_modify_goods.stringdata0))
